namespace OrganizerMVC.Migrations
{
    ...
    public partial class FirstFlush : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .Index(t => new { t.OrganizerId, t.EventId }, unique: true, name: "IX_UniqueOrganizerEvent");
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrganizerEvent", "OrganizerId", "dbo.Organizers");
            DropForeignKey("dbo.Organizers", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.OrganizerEvent", "EventId", "dbo.Events");
            ...
            DropIndex("dbo.OrganizerEvent", "IX_UniqueOrganizerEvent");
